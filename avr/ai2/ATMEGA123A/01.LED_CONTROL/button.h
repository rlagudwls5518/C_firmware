 ...
 * button.h
 *
 * Created: 2026-06-10 오전 11:45:05
 *  Author: kccistc
 */ 

#define F_CPU 160000000UL // 16MHz
#include <avr/io.h> // PORTA PORTB PORTD... IO관련 reg가 들어있다
#define <util/delay.h> // _delay_ms _delay_us 등의 함수가 들어있다.
...
#define BUTTON0 1 //PORTD.4의 가상 index(sw번호)
#define BUTTON0 2 //PORTD.5의 가상 index(sw번호)
#define BUTTON0 3 //PORTD.6의 가상 index(sw번호)
